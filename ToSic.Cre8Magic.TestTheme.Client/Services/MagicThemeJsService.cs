...
public class MagicThemeJsService(IJSRuntime jsRuntime, IMagicSettingsService settingSvc)
    : MagicJsServiceBase(jsRuntime, settingSvc, $"./{ThemePathPlaceholder}/interop/page-control.js"), IMagicThemeJsService
{
    /// <inheritdoc />
