...
internal class TestDatabase
{
    ...
    [
        ...
        new("language-custom-catalog", "Language - Custom Book", typeof(TestLanguagesWithCustomCatalog)),
        ...
        new("menu-tut-coded", "Menus - Tutorial - Coded", typeof(MenuTutorialCoded)),
