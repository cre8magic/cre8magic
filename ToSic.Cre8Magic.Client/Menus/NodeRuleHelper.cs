    ...
    private List<IMagicPage> FindInitialAnchorPages(StartNodeRule n)
    {
        ...
        switch (n.ModeInfo)
        {
            ...
            case StartMode.Current when n.Level > 0:
                ...
                var fromTop = PageFactory.Breadcrumb.Get(new() { Pages = source, Current = Current }).Skip(skipDown).FirstOrDefault();
            ...
            case StartMode.Current when n.Level < 0:
                ...
                var fromCurrent = PageFactory.Breadcrumb.Get(new() { Pages = source, Current = Current }).ToList().Skip(skipUp).FirstOrDefault();
