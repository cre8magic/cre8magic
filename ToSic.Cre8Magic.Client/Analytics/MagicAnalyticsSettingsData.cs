...
/// </summary>
public record MagicAnalyticsSettingsData : SettingsWithInherit, ICanClone<MagicAnalyticsSettingsData>
{
    #region Constructor and Clone

    [PrivateApi]
    public MagicAnalyticsSettingsData() { }

    [PrivateApi]
    internal MagicAnalyticsSettingsData(MagicAnalyticsSettingsData? priority, MagicAnalyticsSettingsData? fallback = default)
    ...
    [PrivateApi]
    MagicAnalyticsSettingsData ICanClone<MagicAnalyticsSettingsData>.CloneUnder(MagicAnalyticsSettingsData? priority, bool forceCopy = false) => 
    ...
    internal static Defaults<MagicAnalyticsSettingsData> Defaults = new(new()
    {
        GtmId = null,
        PageViewTrack = false,
