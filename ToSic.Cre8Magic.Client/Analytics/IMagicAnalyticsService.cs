...
public interface IMagicAnalyticsService
{
    ...
    /// <param name="settings">Optional settings to use - otherwise will look them up.</param>
    /// <returns></returns>
    Task TrackPage(PageState pageState, bool isFirstRender, MagicAnalyticsSettings? settings = default);
}