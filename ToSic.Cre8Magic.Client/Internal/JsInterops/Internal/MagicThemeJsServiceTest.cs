...
public class MagicThemeJsServiceTest(IJSRuntime jsRuntime, IMagicSpellsService spellsSvc)
    : MagicJsServiceBase(jsRuntime, spellsSvc, $"./_content/{MagicConstants.PackageId}/test.js"), IMagicThemeJsService
{
    /// <inheritdoc />
