...
internal class MagicSettingsProvider: IMagicSettingsProvider, IMagicSettingsSource
{
    ...
    public IMagicSettingsProviderSection<MagicAnalyticsSettingsData> Analytics => _analytics ??= new(this);
    private MagicSettingsProviderSection<MagicAnalyticsSettingsData>? _analytics;
    ...
    public IMagicSettingsProviderSection<MagicContainerSettingsData> Containers => _containers ??= new(this);
    private MagicSettingsProviderSection<MagicContainerSettingsData>? _containers;
