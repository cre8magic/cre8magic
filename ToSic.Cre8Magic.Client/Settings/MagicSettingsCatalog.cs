...
public record MagicSettingsCatalog: IHasDebugSettings
{
    ...
    [JsonConverter(typeof(CaseInsensitiveDictionaryConverter<MagicContainerSettingsData>))]
    public Dictionary<string, MagicContainerSettingsData> Containers { get; init; } = new(InvariantCultureIgnoreCase);
    ...
    /// </summary>
    [JsonConverter(typeof(CaseInsensitiveDictionaryConverter<MagicMenuDesignSettings>))]
    public Dictionary<string, MagicMenuDesignSettings> MenuDesigns { get; init; } = new(InvariantCultureIgnoreCase);
