...
public class MagicLanguageDesigner(MagicThemeContextFull context, MagicLanguageSettings settingsFull) : MagicDesignerBase(context, settingsFull.DesignSettings?.ByName)
{
    /// <summary>
